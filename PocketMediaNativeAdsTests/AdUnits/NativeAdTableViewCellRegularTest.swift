...
class NativeAdTableViewCellTest: XCTestCase {
    ...
    //    var subject: NativeViewCell!
    //
    //    override func setUp() {
    //        super.setUp()
    //
    //        let unit = AdUnit(type: AdUnit.UIType.TableView)
    //        let ad = testHelpers.getNativeAd()
    //
    //        let nib = UINib.init(nibName: unit.getNibIdentifier(ad: ad), bundle: nil)
    //        subject = nib as! NativeViewCell
    //    }
    //
    ...
    //
    //        // Call
    //        subject.render(ad, completion: { (success: Bool) in
    //            // TOOD: Check this maybe?
    //        })
    //
    ...
    //        //        XCTAssert(iButton.layer.borderColor == color.cgColor)
