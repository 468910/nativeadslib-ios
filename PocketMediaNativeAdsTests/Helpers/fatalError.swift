...
//@noreturn func fatalError( message: @autoclosure () -> String = "", file: StaticString = #file, line: UInt = #line) {
...
//        dispatch_async(dispatch_get_global_queue(Int(QOS_CLASS_USER_INITIATED.rawValue), 0), testcase)
//
