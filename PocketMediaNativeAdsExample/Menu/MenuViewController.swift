...
class MenuViewController: UIViewController, UIPopoverPresentationControllerDelegate {
	...
	override func viewDidLoad() {
		...
		tableviewWithSectionsButton.setTitleColor(UIColor.white, for: UIControlState())
		tableviewWithSectionsButton.setTitle("TableViewWithSections", for: UIControlState())

		// ScrollViewButton
		scrollViewButton.setTitle("ScrollView", for: UIControlState())
		scrollViewButton.setTitleColor(UIColor.white, for: UIControlState())
		...
		tableviewBigAdsButton.setTitle("TableViewBigAdsButton", for: UIControlState())
		tableviewBigAdsButton.setTitleColor(UIColor.white, for: UIControlState())
